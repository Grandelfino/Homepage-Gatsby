module.exports = {
  pathPrefix: '/',
  title: 'Grandelfino', // タイトル
  titleAlt: 'Grandelfino', // JSONLDのためのタイトル
  description: 'Grandelfinoは京都工芸繊維大学の学生フォーミュラプロジェクトチームです。2007年度大会から参戦し、2012・2016・2017年度には総合優勝を果たしました。',
  url: 'https://www.grandelfino.net', // スラッシュなしのサイトURL
